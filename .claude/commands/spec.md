...
You are helping to spin up a new feature spec for this application, from a short idea provided in the user input flow. Always adhere to any rules or requirements set out in any CLAUDE.md files when responding.
...
1. `feature_title`
  - A short, humand readable title in Title Case.
...
2. `feature_slug`
  ...
  - Examples: `card-component` or `card-component-dashboard`
